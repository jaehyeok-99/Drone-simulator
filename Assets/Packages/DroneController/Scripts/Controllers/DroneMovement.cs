...
namespace DroneController
{
    ...
    public class DroneMovement : MonoBehaviour
    {
        ...
        public Vector3 Velocity { get { return _rigidbody.linearVelocity; } }
        ...
        {
            _rigidbody.linearVelocity = Vector3.ClampMagnitude(_rigidbody.linearVelocity, Mathf.Lerp(_rigidbody.linearVelocity.magnitude, _droneMovementData.MaximumPitchSpeed, Time.deltaTime * 5f));
            if (InputManager.Instance.IsInputIdle())
            {
                _rigidbody.linearVelocity = Vector3.SmoothDamp(_rigidbody.linearVelocity, Vector3.zero, ref _smoothDampToStopVelocity, _droneMovementData.SlowDownTime);
            }
        }
